...
class DokterController extends Controller
{
    ...
    public function createDokter(Request $request)
    {
        $request->validate([
            ...
            //'foto_dokter'        => 'nullable|file|mimetypes:image/jpeg,image/png,image/gif,image/webp,image/svg+xml,image/pjpeg,image/jfif,image/jpg|max:5120',
            'foto_dokter' => 'nullable|mimes:jpeg,jpg,png,gif,webp,svg|max:5120',

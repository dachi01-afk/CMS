...
class OrderRadiologiController extends Controller
{
    ...
    public function simpanHasil(Request $request)
    {
        $request->validate([
            ...
            // upload per detail: foto_hasil_radiologi[detail_id]
        ...
        try {
            DB::transaction(function () use ($request) {
                ...
                $order = OrderRadiologi::with('orderRadiologiDetail.jenisPemeriksaanRadiologi')
                    ->findOrFail($request->order_radiologi_id);
                ...
                foreach ($order->orderRadiologiDetail as $detail) {
                    ...
                    // kalau ada file untuk detail ini
                    ...
                    HasilRadiologi::updateOrCreate(
                        ...
                        [
                            ...
                            'foto_hasil_radiologi' => $path, // bisa null kalau ga upload
                    ...
                    $summary[] = ($detail->jenisPemeriksaanRadiologi->nama_pemeriksaan ?? 'Pemeriksaan') . ': ' . ($path ? 'foto terupload' : 'tanpa foto');
                }
            ...
            return response()->json(['success' => true, 'message' => 'Hasil radiologi berhasil disimpan!']);
        } catch (\Exception $e) {

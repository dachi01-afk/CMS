...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.pilih-kyad-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            document.getElementById('dokter_id-kyad').value = btn.dataset.dokterId;
            document.getElementById('dokter_nama-kyad').value = `${btn.dataset.dokterNama} (${btn.dataset.spesialis})`;
            document.getElementById('nama_poli-kyad').value = btn.dataset.namaPoli;
        ...
        if (data.length > 0) {
            ...
            data.forEach(pasien => {
                ...
                item.onclick = () => {
                    ...
                    document.getElementById('nama_pasien-kyad').textContent = pasien.nama_pasien;
                    document.getElementById('alamat_pasien-kyad').textContent = pasien.alamat;
                    document.getElementById('jk_pasien-kyad').textContent = pasien.jenis_kelamin;

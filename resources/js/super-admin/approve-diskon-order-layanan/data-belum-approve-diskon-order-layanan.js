...
$(function () {
    const url = "/super-admin/approve-diskon-order-layanan/get-data-belum-approve";
    table = $("#tabel-belum-approve-diskon-order-layanan").DataTable({
        processing: true,
        serverSide: true,
        responsive: true,
        paging: true,
...
$(function () {
    ...
    // =========================================================
        ...
        // =========================================================
        $("#tabel-belum-approve-diskon-order-layanan").on(
            "click",
        ...
        $("#tabel-belum-approve-diskon-order-layanan").on(
            "click",
            ".btn-approve-diskon-order-layanan",
            async function () {
                const $btn = $(this);
        ...
        $("#tabel-belum-approve-diskon-order-layanan").on(
            "click",
            ".btn-reject-diskon-order-layanan",
            async function () {
                const $btn = $(this);
                const approvalId = $btn.data("approval-id");

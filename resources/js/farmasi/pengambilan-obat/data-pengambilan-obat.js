...
$(function () {
    $("body").on("click", ".btnCetakStikerObat", function () {
        ...
        // 🔗 Silakan sesuaikan URL ini dengan route yang kamu buat
        const url = `/farmasi/pengambilan-obat/cetak-stiker-obat/${resepId}`;

        // buka tab baru untuk halaman cetak stiker obat

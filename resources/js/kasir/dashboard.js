document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function loadChart(range = "harian") {
        const url = `/kasir/get-data-pemasukan?range=${encodeURIComponent(
            range
        )}`;
    ...
    await Promise.all([
        ...
        getData("/kasir/get-data-transaksi-hari-ini", "totalTransaksiHariIni"),
        getData(
            "/kasir/get-data-total-keseluruhan-transaksi",
            "totalKeseluruhanTransaksi"
        ),
        getData(
            "/kasir/get-data-transaksi-obat-hari-ini",
            "totalTransaksiObatHariIni"
        ),
        getData(
            "/kasir/get-data-total-keseluruhan-transaksi-obat",

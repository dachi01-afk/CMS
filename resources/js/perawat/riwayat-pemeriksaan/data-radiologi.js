...
$(function () {
    const table = $("#tabelRiwayatRadiologi").DataTable({
        processing: true,
        serverSide: true,
        paging: true,
        searching: true,
        ...
        lengthChange: false,
        info: false,
        ajax: "/perawat/riwayat-pemeriksaan/radiologi/data",
        columns: [
            {
                data: "DT_RowIndex",
                name: "DT_RowIndex",
    ...
    // Search
    $("#riwayatRadiologi_searchInput").on("keyup", function () {
        table.search(this.value).draw();
    });

    // Custom pagination & info
    const $info = $("#riwayatRadiologi_customInfo");
    const $pagination = $("#riwayatRadiologi_customPagination");
    const $perPage = $("#riwayatRadiologi_pageLength");

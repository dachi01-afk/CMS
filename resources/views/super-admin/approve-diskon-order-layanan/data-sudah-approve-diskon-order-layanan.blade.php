<section class="space-y-5">
        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                <h2 class="text-xl font-bold text-slate-800 dark:text-slate-50 md:text-2xl">
                    Data Diskon Order Layanan Sudah Diapprove
                </h2>

                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                    Menampilkan riwayat permintaan diskon yang sudah disetujui atau ditolak oleh
    ...
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
        ...
        <div class="overflow-x-auto">
            <table id="tabel-sudah-approve-diskon-order-layanan"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400">
                            Data item diskon yang sudah diproses manager.
                        </p>
                    </div>
                </div>
                ...
                <div class="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-200 dark:bg-slate-900/30 dark:ring-slate-700">
                    <div class="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                        <div class="space-y-1">
                            ...
                            <div class="text-sm text-slate-700 dark:text-slate-200">
                                Approved By: <b id="modalApprovedBySudahApprove">-</b>
                            </div>
                            <div class="text-sm text-slate-700 dark:text-slate-200">
                                Status:
                                <span id="modalStatusSudahApprove"
                                    class="inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-xs font-semibold text-slate-700 ring-1 ring-slate-200">
                                    -
                                </span>
                            </div>
                        </div>
                    ...
                    <div id="modalRejectReasonWrapSudahApprove" class="mt-3 hidden">
                        <div class="mb-1 text-xs font-semibold text-rose-700 dark:text-rose-300">
                            Alasan Penolakan
                        </div>
                        <div id="modalRejectReasonSudahApprove"
                            class="whitespace-pre-line rounded-xl bg-white p-3 text-sm text-rose-700 ring-1 ring-rose-200 dark:bg-slate-800 dark:text-rose-300 dark:ring-rose-800">
                            -
                        </div>
                    </div>
                </div>
...
@vite(['resources/js/super-admin/approve-diskon-order-layanan/data-sudah-approve-diskon-order-layanan.js'])

<section class="space-y-5">
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm">
        ...
        <div class="overflow-x-auto">
            <table id="tabel-belum-approve-diskon-order-layanan"
...
@vite(['resources/js/super-admin/approve-diskon-order-layanan/data-belum-approve-diskon-order-layanan.js'])

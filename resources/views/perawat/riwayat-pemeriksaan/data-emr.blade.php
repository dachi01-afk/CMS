        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Menampilkan EMR yang <span class="font-semibold">kamu input</span>.
                </p>
            </div>
        </div>
    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center gap-2">
                ...
                <select id="emr_pageLength"
                    class="border border-slate-300 dark:border-slate-600 text-xs md:text-sm rounded-xl
                           focus:ring-sky-500 focus:border-sky-500 bg-white dark:bg-slate-800 px-2 py-1.5 w-24">
            ...
            <div class="w-full md:w-auto">
                <div class="relative">
                    ...
                    <input type="text" id="emr_searchInput"
                        class="block w-full md:w-64 lg:w-72 pl-8 pr-3 py-2 text-sm rounded-xl
                               border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800
                               text-slate-800 dark:text-slate-50 placeholder:text-slate-400 dark:placeholder:text-slate-500
                               focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
                        placeholder="Cari pasien, dokter, keluhan, diagnosis...">
                </div>
            </div>
        </div>

        <div class="overflow-x-auto">
            <table id="tabelRiwayatEmr"
                ...
                <thead class="text-xs uppercase bg-gradient-to-r from-sky-500 to-teal-500 text-white">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-[11px] font-semibold tracking-wide">No EMR</th>
        ...
        <div
            ...
            <div id="emr_customInfo" class="text-xs md:text-sm text-slate-600 dark:text-slate-300"></div>
            <ul id="emr_customPagination" class="inline-flex items-center gap-1 text-xs md:text-sm"></ul>
        </div>
    </div>
</section>

@vite(['resources/js/perawat/riwayat-pemeriksaan/emr.js'])

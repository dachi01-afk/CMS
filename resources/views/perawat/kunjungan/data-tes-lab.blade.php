        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                <h2 class="text-xl md:text-2xl font-bold text-slate-800 dark:text-slate-50">
                    Daftar Order Laboratorium
                </h2>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Monitoring pasien yang sudah <span class="font-semibold">engaged</span> dan siap dilakukan Tes
                    Laboratorium oleh perawat.
                </p>
            </div>
        </div>
            ...
            <table id="tabel-order-lab"
                ...
                <thead class="text-xs uppercase bg-gradient-to-r from-sky-500 to-teal-500 text-white">
                    <tr>
                        ...
                        <th class="px-5 py-3 text-[11px] font-semibold tracking-wide">Item Pemeriksaan</th>
                        <th class="px-5 py-3 text-[11px] font-semibold tracking-wide">Dokter</th>
                        <th class="px-5 py-3 text-[11px] font-semibold tracking-wide">Status</th>

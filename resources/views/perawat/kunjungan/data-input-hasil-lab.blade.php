    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white shadow-lg rounded-xl overflow-hidden">
            <div class="bg-indigo-600 px-6 py-4">
                <h2 class="text-white text-xl font-bold">Input Hasil Laboratorium</h2>
                <p class="text-indigo-100 text-sm">No. Order: {{ $order->no_order_lab }}</p>
            </div>
                ...
                <div class="p-6">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($order->orderLabDetail as $detail)
                                <tr>
                                    <td class="py-4 font-medium text-gray-700">
                                        {{ $detail->jenisPemeriksaanLab->nama_pemeriksaan }}
                                    </td>
                                    <td class="py-4">

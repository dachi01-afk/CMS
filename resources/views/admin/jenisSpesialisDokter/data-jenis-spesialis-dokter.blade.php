...
<div id="editJenisSpesialisDokterModal" aria-hidden="true"
    ...
    <div class="relative w-full max-w-xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-700">
            ...
            {{-- Header --}}
            <div class="flex items-center justify-between p-5 border-b border-gray-200 dark:border-gray-600">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">Edit Data Jenis Spesialis</h3>
            </div>
            ...
            <form id="formEditJenisSpesialisDokter" class="p-5 flex flex-col gap-4"
                ...
                <div class="grid grid-cols-1">
                    {{-- Username --}}
                    <div>
                        <label for="edit-jenis-spesialis-dokter-nama-spesialis"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                        <input type="text" name="nama_spesialis" id="edit-jenis-spesialis-dokter-nama-spesialis"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5
                            focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                            placeholder="Username" required>
                        <div id="nama_spesialis-error" class="text-red-600 text-sm mt-1">
                        </div>
                    </div>
                </div>
                ...
                {{-- Buttons --}}
                <div class="flex justify-end gap-3 mt-5 border-t border-gray-200 pt-4 dark:border-gray-600">
                    <button type="button" id="closeEditJenisSpesialisDokterModal"
                        class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg
                        hover:bg-gray-300 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-500">
                        Close
                    </button>

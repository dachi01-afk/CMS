        ...
        <div class="border-b border-gray-200 dark:border-gray-700 ">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center whitespace-nowrap" id="default-tab"
                ...
                <li class="me-2" role="presentation" id="menuProsesKunjunganMasaDepan">
                    <button id="proses_kunjungan-masa-depan-tab" data-tabs-target="#data-proses_kunjungan_masa_depan"
                        type="button" role="tab" aria-controls="data-proses_kunjungan_masa_depan"
                        aria-selected="{{ $activeTab === 'kunjungan_masa_depan' ? 'true' : 'false' }}"
                        class="inline-block p-4 border-b-2 rounded-t-lg
                       {{ $activeTab === 'kunjungan_masa_depan'
                           ? 'border-sky-500 text-sky-600'
                           : 'border-transparent text-slate-500 hover:text-slate-600 hover:border-slate-300' }}">

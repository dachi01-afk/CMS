...
<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2">
    <h2 class="text-2xl font-bold text-gray-700">Riwayat Transaksi Obat</h2>
</div>
...
<div class="overflow-x-auto rounded-lg shadow-md">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 p-4 border-b border-gray-200">
        ...
        <div class="relative">
            <input type="text" id="transaksi-obat-search-input"
                class="block w-60 p-2 pl-3 text-sm text-gray-900 border border-ray-300 rounded-lg bg-gray-50 focus:ring-sky-500 focus:border-sky-500"
                placeholder="Cari data...">
        </div>
    </div>

    <div class="overflow-x-auto">
        <table id="riwayatTransaksiObatTable" class="w-full text-sm text-left text-gray-600">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between px-4 py-3 border-t border-gray-200 gap-3">
        <div id="transaksi-obat-custom-info" class="text-sm text-gray-700 dark:text-gray-300"></div>
        <ul id="transaksi-obat-custom-paginate" class="inline-flex -space-x-px text-sm"></ul>
    </div>
</div>
...
@vite(['resources/js/admin/pembayaran/riwayat-transaksi-obat.js'])

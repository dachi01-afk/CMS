...
<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2">
    <h2 class="text-2xl font-bold text-gray-700">Laporan Hasil Laboratorium</h2>
</div>
...
<div class="overflow-hidden rounded-lg shadow-md">
    ...
    <div class="overflow-x-auto">
        <table id="labTable" class="w-full text-sm text-left text-gray-600">
...
@vite(['resources/js/admin/dataMedisPasien/data_hasil_lab.js'])

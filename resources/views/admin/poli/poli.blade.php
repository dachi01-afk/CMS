<x-mycomponents.layout>
    ...
    <div>
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 ">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center whitespace-nowrap" id="default-tab"
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="poli-tab"
                        data-tabs-target="#data-poli" type="button" role="tab" aria-controls="data-poli"
                        aria-selected="false">
                        Data Poli
                    </button>
                </li>
        ...
        <div class="p-2 bg-white shadow-lg rounded-lg min-h-screen">
            ...
            {{-- Tabs Content --}}
            <div id="tab-content">
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mt-2" id="data-poli" role="tabpanel"
                    aria-labelledby="poli-tab">
                    @include('admin.poli.data-poli')
                </div>
            </div>

                ...
                @forelse ($jadwalHariIni as $jadwal)
                    <tr class="border-b border-gray-100 hover:bg-indigo-50/40 transition duration-150">
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full font-medium text-sm whitespace-nowrap">
    ...
    <div class="relative w-full max-w-xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-700">
            ...
            <form action="{{ route('jadwal_kunjungan.create') }}" method="POST" class="p-6 space-y-4">
                ...
                <input type="hidden" name="jadwal_id" id="jadwal_id"><!-- ✅ penting -->
                ...
                <div>
                    ...
                    <div id="search_results"
                         class="mt-2 bg-white border border-gray-200 rounded-lg shadow max-h-40 overflow-y-auto hidden"></div>
                </div>

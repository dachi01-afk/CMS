<section class="space-y-5">
    ...
    {{-- HEADER PROSES KUNJUNGAN (MATCH STYLE JADWAL DOKTER) --}}
    <div
    ...
    {{-- CARD PROSES KUNJUNGAN + TABEL (MATCH CONCEPT CARD TABEL JADWAL) --}}
    ...
    {{-- MODAL: Edit Kunjungan (DISAMAKAN VIBE DENGAN MODAL TAMBAH KUNJUNGAN) --}}

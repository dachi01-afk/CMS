        ...
        <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-700">
            ...
            <form action="{{ route('jadwal_kunjungan.create') }}" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="dokter_nama-kyad" name="dokter_nama" readonly
                ...
                <div>
                    ...
                    <input type="text" id="nama_poli-kyad" readonly
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white">
                ...
                <!-- Data Pasien -->
                <div id="pasien_data-kyad" class="hidden space-y-1 text-sm text-gray-700 dark:text-gray-300">
                    <input type="hidden" name="pasien_id" id="pasien_id-kyad">

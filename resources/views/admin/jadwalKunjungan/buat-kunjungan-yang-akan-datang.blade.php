<section class="space-y-5">
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm">
        ...
        {{-- Toolbar atas: info + (opsional) search --}}
        <div
            ...
            {{-- Search kecil khusus jadwal yang akan datang (opsional, bisa dipakai di JS nanti) --}}
            <div class="w-full md:w-auto">
                <div class="relative">
                    ...
                    <input type="text" id="jadwal_kyad_searchInput"
                        class="block w-full md:w-72 pl-8 pr-3 py-2 text-sm text-slate-800 dark:text-slate-100
        ...
        <div class="relative overflow-x-auto rounded-b-2xl">
                        ...
                        <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-700/60 transition-colors">
                            ...
                            <td class="px-6 py-3.5">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="h-9 w-9 flex items-center justify-center rounded-xl bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-200">
                            ...
                            <td class="px-6 py-3.5 text-center">
                                <button type="button"
                                    class="pilih-kyad-btn inline-flex items-center justify-center gap-1.5
                                           ...
                                           focus:outline-none focus:ring-2 focus:ring-sky-400 px-3.5 py-1.5"
            ...
            @if ($jadwalYangAkanDatang->count())
                <div
                    ...
                    <div>
                        {{-- penting: appends tab=tkyad supaya setelah klik halaman, tab yg aktif tetap "Tambah Kunjungan Yang Akan Datang" --}}

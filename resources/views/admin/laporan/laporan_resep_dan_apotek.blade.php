...
<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-2">
    <h2 class="text-2xl font-bold text-gray-700">Laporan Transaksi Apoteker</h2>
</div>

<!-- Tabel Transaksi Apoteker -->
<div class="overflow-hidden rounded-lg shadow-md">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 p-4 border-b border-gray-200">
        <div>
            <select id="transaksi_pageLength"
        ...
        <div class="relative">
            <input type="text" id="transaksi_searchInput"
    ...
    <div class="overflow-x-auto">
        <table id="transaksiTable" class="w-full text-sm text-left text-gray-600">
            <thead class="text-xs uppercase bg-sky-500 text-white">
                <tr>
                    ...
                    <th class="px-6 py-3">Total Harga (Rp)</th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between px-4 py-3 border-t border-gray-200 gap-3">
        <div id="transaksi_customInfo" class="text-sm text-gray-700 dark:text-gray-300"></div>
        <ul id="transaksi_customPagination" class="inline-flex -space-x-px text-sm"></ul>
    </div>
</div>

@vite(['resources/js/admin/laporan/laporan_resep_dan_apotek.js'])

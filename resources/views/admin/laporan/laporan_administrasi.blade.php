...
<div class="overflow-hidden rounded-lg shadow-md">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 p-4 border-b border-gray-200">
        <div>
            <select id="administrasi_pageLength"
        ...
        <div class="relative">
            <input type="text" id="administrasi_searchInput"
    ...
    <div class="overflow-x-auto">
        <table id="administrasiTable" class="w-full text-sm text-left text-gray-600">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between px-4 py-3 border-t border-gray-200 gap-3">
        <div id="administrasi_customInfo" class="text-sm text-gray-700 dark:text-gray-300"></div>
        <ul id="administrasi_customPagination" class="inline-flex -space-x-px text-sm"></ul>
    </div>
</div>

@vite(['resources/js/admin/laporan/laporan_administrasi.js'])

<section class="space-y-5">
        ...
        <div class="flex items-start gap-3 md:flex-1">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Lihat dan telusuri seluruh data riwayat stok masuk obat, mulai dari supplier, depot,
                    nomor faktur, hingga status stok masuk.
                    <span class="hidden sm:inline">
                        Gunakan pencarian untuk menemukan data stok masuk dengan lebih cepat dan akurat.
                    </span>
                </p>
            </div>
        </div>
    ...
    <div
        ...
        <div class="px-3 sm:px-4 md:px-6 py-3 border-b border-slate-200 dark:border-slate-700">
            <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                ...
                <div class="flex items-center gap-2 text-sm w-full md:w-auto">
                    ...
                    <select id="riwayat-stok-masuk-obat-page-length"
                ...
                <div class="w-full md:w-auto">
                    <div class="relative">
                        ...
                        <input type="text" id="riwayat-stok-masuk-obat-search-input"
                            class="block w-full md:w-80 pl-9 pr-3 py-2 text-sm
                                   text-slate-800 dark:text-slate-100
                                   border border-slate-300 dark:border-slate-600 rounded-lg
                                   bg-slate-50 dark:bg-slate-700
                                   focus:ring-sky-500 focus:border-sky-500"
                            placeholder="Cari supplier, depot, no faktur, atau status stok masuk...">
                    </div>

                    <p class="mt-1 text-[11px] text-slate-400 dark:text-slate-500 hidden sm:block">
                        Contoh: <span class="italic">Nama supplier, no faktur, nama depot, succeed</span>.
                    </p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table id="table-riwayat-stok-masuk-obat"
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 sm:px-4 md:px-6 py-3 whitespace-nowrap">Status Stok Masuk</th>
                        <th
        ...
        <div
            ...
            <div id="riwayat-stok-masuk-obat-custom-info" class="text-xs md:text-sm text-slate-600 dark:text-slate-300">
            </div>

            <div class="w-full md:w-auto overflow-x-auto">
                <ul id="riwayat-stok-masuk-obat-custom-pagination"
...
<div id="riwayat-modal-detail-stok-masuk-obat"
    ...
    <div class="w-full max-w-6xl max-h-[95vh] overflow-hidden rounded-3xl bg-white shadow-2xl">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Informasi lengkap transaksi stok masuk obat.
                    </p>
                </div>
            </div>

            <button type="button" id="button-close-modal-detail-riwayat-stok-masuk-obat"
        ...
        <div class="max-h-[calc(95vh-88px)] overflow-y-auto p-6 space-y-6">
            <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-5">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3 text-sm">
                    <div>
                        ...
                        <p id="riwayat-stok-masuk-obat-detail_supplier" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Depot</p>
                        <p id="riwayat-stok-masuk-obat-detail_depot" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">No Faktur</p>
                        <p id="riwayat-stok-masuk-obat-detail_no_faktur" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Tanggal Diterima</p>
                        <p id="riwayat-stok-masuk-obat-detail_tanggal_terima" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Tanggal Jatuh Tempo</p>
                        <p id="riwayat-stok-masuk-obat-detail_tanggal_jatuh_tempo" class="font-semibold text-slate-800">
                            -</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Status Stok Masuk</p>
                        <p id="riwayat-stok-masuk-obat-detail_status_transaksi" class="font-semibold text-slate-800">-
                        </p>
                    </div>
                    <div class="md:col-span-2 xl:col-span-3">
                        <p class="text-slate-500">Total Tagihan</p>
                        <p id="riwayat-stok-masuk-obat-detail_total_tagihan"
                            class="font-bold text-emerald-600 text-base">
                            Rp 0
                        </p>
                    </div>
                </div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5">
                <div class="mb-4 flex items-center gap-2">
                    ...
                    <h4 class="text-sm font-bold uppercase tracking-wide text-slate-700">
                        Detail Item Riwayat Stok Masuk
                    </h4>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
                        ...
                        <tbody id="detail-riwayat-stok-masuk-obat-tbody" class="divide-y divide-slate-200">
                            <tr>
        ...
        <div class="border-t border-slate-200 px-6 py-4 flex justify-end">
            <button type="button" id="button-close-footer-modal-detail-riwayat-stok-masuk-obat"
...
@vite(['resources/js/farmasi/stok-masuk-obat/data-riwayat-stok-masuk-obat.js'])

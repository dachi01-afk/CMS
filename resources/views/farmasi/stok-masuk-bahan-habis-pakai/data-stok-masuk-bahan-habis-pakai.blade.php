<section class="space-y-5">
        ...
        <div class="flex items-start gap-3 md:flex-1">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Menampilkan daftar restock bahan habis pakai yang belum dikonfirmasi sebagai stok masuk.
    ...
    <div
        ...
        <div class="overflow-x-auto">
            <table id="table-stok-masuk-bahan-habis-pakai"
...
<div id="modal-detail-stok-masuk-bahan-habis-pakai"
    ...
    <div
        ...
        <div
            ...
            <div>
                <h3 class="text-lg md:text-xl font-bold text-slate-800 dark:text-slate-100">
                    Detail Stok Masuk Bahan Habis Pakai
                </h3>
                <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Informasi transaksi restock dan detail item bahan habis pakai.
                </p>
            </div>

            <button type="button" id="btn-close-modal-detail-stok-masuk-bahan-habis-pakai"
        ...
        <div
            ...
            <button type="button" id="btn-close-footer-modal-detail-stok-masuk-bahan-habis-pakai"
...
@vite(['resources/js/farmasi/stok-masuk-bahan-habis-pakai/data-stok-masuk-bahan-habis-pakai.js'])

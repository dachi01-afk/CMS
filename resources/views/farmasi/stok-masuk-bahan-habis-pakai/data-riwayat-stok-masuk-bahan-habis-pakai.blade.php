<section class="space-y-5">
        ...
        <div class="flex items-start gap-3 md:flex-1">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Lihat dan telusuri seluruh data riwayat stok masuk bahan habis pakai, mulai dari supplier, depot,
    ...
    <div
        ...
        <div class="overflow-x-auto">
            <table id="table-riwayat-stok-masuk-bhp"
...
<div id="riwayat-stok-masuk-bhp"
    data-get-data-stok-masuk-bhp-detail-url="{{ route('farmasi.get.data.restock.bahan.habis.pakai.by.id', ':id') }}">
</div>

<div id="riwayat-modal-detail-stok-masuk-bhp"
    ...
    <div class="w-full max-w-6xl max-h-[95vh] overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div class="flex items-start justify-between border-b border-slate-200 px-6 py-5">
            ...
            <button type="button" id="button-close-modal-detail-riwayat-stok-masuk-bhp"
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-5">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4 text-sm">
                    ...
                    <div>
                        ...
                        <p id="riwayat-stok-masuk-bhp-detail_depot" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p id="riwayat-stok-masuk-bhp-detail_tanggal_jatuh_tempo" class="font-semibold text-slate-800">
                            -</p>
                    </div>
                    <div>
                    ...
                    <div class="md:col-span-2 xl:col-span-3">
                        ...
                        <p id="riwayat-stok-masuk-bhp-detail_total_tagihan"
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
                        ...
                        <tbody id="detail-riwayat-stok-masuk-bhp-tbody" class="divide-y divide-slate-200">
                            <tr>
        ...
        <div class="border-t border-slate-200 px-6 py-4 flex justify-end">
            <button type="button" id="button-close-footer-modal-detail-riwayat-stok-masuk-bhp"
...
@vite(['resources/js/farmasi/stok-masuk-bahan-habis-pakai/data-riwayat-stok-masuk-bahan-habis-pakai.js'])

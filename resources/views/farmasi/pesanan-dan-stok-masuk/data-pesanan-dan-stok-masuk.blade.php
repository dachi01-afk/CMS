...
<div class="mb-4 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
    <div>
        <h1 class="text-2xl font-bold text-slate-800 dark:text-slate-100">Pesanan Dan Stok Masuk</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400">
            Kelola Data Pesanan Dan Stok Masuk Pada Apotek
        </p>
    </div>
...
<div
    ...
    <div class="overflow-x-auto">
        <table id="table-pesanan-dan-stok-masuk" class="w-full text-sm">
            <thead class="bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-200">
                <tr>
                    ...
                    <th class="px-4 py-3">Nama Farmasi</th>
...
@vite(['resources/js/farmasi/pesanan-dan-stok-masuk/data-pesanan-dan-stok-masuk.js'])

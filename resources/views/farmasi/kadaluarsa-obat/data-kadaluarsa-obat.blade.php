<div class="px-2 md:px-4 lg:px-6 py-4 md:py-6 space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div>
            ...
            <p class="text-xs md:text-sm text-slate-500 dark:text-slate-400 mt-1">
                Pantau obat yang sudah mendekati tanggal kadaluarsa agar stok dapat diputar tepat waktu.
            </p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-sm">
            ...
            <div class="flex items-center gap-2">
                ...
                <div>
                    <h2 class="text-sm md:text-base font-semibold text-slate-900 dark:text-slate-50">
                        Warning Kadaluarsa Obat
                    </h2>
                    <p class="text-[11px] md:text-xs text-slate-500 dark:text-slate-400">
                        Menampilkan obat yang akan kadaluarsa ≤ <span id="warningThresholdText">7</span> hari ke depan.
                    </p>
                </div>
            </div>
            <span
        ...
        <div class="px-4 md:px-6 py-4 overflow-x-auto">
            <table
                class="min-w-full text-xs md:text-sm border border-slate-500 dark:border-slate-800 rounded-xl overflow-hidden">
                <thead class="bg-slate-300 dark:bg-slate-800/60">
                    <tr class="text-[11px] md:text-xs text-black dark:text-slate-300">
                ...
                <table id="tableKadaluarsaObat"
                    ...
                    <thead class="bg-slate-50 dark:bg-slate-800/60">
                        <tr class="text-[11px] md:text-xs text-slate-600 dark:text-slate-300">
                            ...
                            <th class="px-3 py-2 text-left font-semibold">Nama Obat</th>
...
@vite(['resources/js/farmasi/kadaluarsa-obat/data-kadaluarsa-obat.js'])

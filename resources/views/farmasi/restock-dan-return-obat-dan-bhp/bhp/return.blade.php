 {{-- BHP --}}
        <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-gray-300">
                Bahan Habis Pakai Return <span class="text-red-500">*</span>
            </label>
        ...
        <div>
            ...
            <input type="date" name="expired_date_bhp" required
                class="mt-1 block w-full text-sm bg-transparent border border-gray-200 rounded-lg px-3 py-2 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white" />
        </div>
        ...
        <div>
            ...
            <input type="text" id="total_stok_bhp" readonly value="0"
                class="mt-1 block w-full text-sm bg-gray-100 border border-gray-200 rounded-lg px-3 py-2 dark:bg-gray-800 dark:border-gray-700 dark:text-white" />
        </div>
        ...
        <div>
            ...
            <input type="number" min="0" name="jumlah_bhp" value="0" required
                class="mt-1 block w-full text-sm bg-transparent border border-gray-200 rounded-lg px-3 py-2 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white" />
        </div>
        ...
        <div>
            ...
            <input type="text" id="harga_satuan_bhp" readonly
                class="input-rupiah mt-1 block w-full text-sm bg-gray-100 border border-gray-200 rounded-lg px-3 py-2 dark:bg-gray-800 dark:border-gray-700 dark:text-white" />
        </div>

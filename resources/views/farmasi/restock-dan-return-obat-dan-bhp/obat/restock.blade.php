 ...
 {{-- Nama Obat --}}
                    ...
                    {{-- Harga Total Diskon (RETURN ONLY) --}}
                    <div >
                    <label
                        class="block text-[11px] font-medium text-gray-500 dark:text-gray-400"
                    >
                    ...
                    <input
                        type="text"
                        name="harga_total_diskon_obat_return"
                        id="harga_total_diskon_obat_return"
                        readonly
                    ...
                    <div
                        class="text-red-600 text-[11px] mt-1"
                        data-error="harga_total_diskon_obat_return"
                    ></div>
                    </div>
                    ...
                    <textarea
                        name="keterangan_obat_return"
                        id="keterangan_obat_return"
                        rows="3"
                        class="mt-1 block w-full text-sm bg-transparent border border-gray-200 rounded-lg px-3 py-2 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-white"
                        placeholder="Masukkan alasan atau keterangan return..."
                    ></textarea>

                    <div
                        class="text-red-600 text-[11px] mt-1"
                        data-error="keterangan_obat_return"
                    ></div>
                    </div>

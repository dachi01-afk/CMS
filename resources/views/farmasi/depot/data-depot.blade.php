    ...
    <div class="relative w-full max-w-5xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <form id="form-modal-repair-obat" class="px-6 py-5 space-y-7 overflow-y-auto"
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 px-6 py-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50/70 dark:bg-slate-800/60">
                ...
                <div class="p-6 flex justify-end gap-3 border-t border-slate-100">
                    ...
                    <button type="button" id="btn-save-repair"

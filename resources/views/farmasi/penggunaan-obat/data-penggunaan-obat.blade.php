...
<div class="space-y-4">
    ...
    <div
        ...
        <div class="space-y-1">
            ...
            <p class="text-[11px] md:text-xs text-slate-500 dark:text-slate-300">
                Rekap penggunaan obat berdasarkan resep yang sudah diambil. Atur rentang tanggal & cari nama obat
                untuk melihat detail pemakaian.
            </p>
        ...
        <div class="flex flex-col md:flex-row gap-2 md:items-end">
            ...
            <div class="flex flex-col md:w-56">
                <label for="filter_nama_obat"
                    class="text-[11px] font-medium text-slate-600 dark:text-slate-200 mb-1">Cari Nama Obat</label>
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-2 text-slate-400">
                        <i class="fa-solid fa-magnifying-glass text-[10px]"></i>
                    </span>
                    <input type="text" id="filter_nama_obat"
            ...
            <div class="flex gap-2">
                <button id="btn-filter-penggunaan-obat" type="button"
                ...
                <button id="btn-reset-penggunaan-obat" type="button"
                    class="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold rounded-lg
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
        ...
        <div class="flex gap-2 justify-end">
           ...
           dark:border-emerald-400 dark:text-emerald-200 dark:hover:bg-emerald-900/20">
            ...
            <button id="btn-print-penggunaan-obat" type="button"
                class="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-semibold rounded-lg
    ...
    <div
        ...
        <div class="overflow-x-auto">
            <table id="table-penggunaan-obat" class="min-w-full text-xs text-left text-slate-600 dark:text-slate-100"
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 py-2 text-center">Nominal Obat Umum</th>
                        <th class="px-3 py-2 text-center">Penggunaan BPJS</th>
                        <th class="px-3 py-2 text-center">Nominal Obat BPJS</th>
                        <th class="px-3 py-2 text-center">Sisa Obat</th>
                    </tr>
                </thead>
...
@vite(['resources/js/farmasi/penggunaan-obat/data-penggunaan-obat.js'])

<section class="space-y-5">
        ...
        <div class="flex items-start gap-3 md:flex-1">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Lihat dan telusuri seluruh data riwayat restock obat, mulai dari supplier, depot,
    ...
    <div
        ...
        <div class="px-3 sm:px-4 md:px-6 py-3 border-b border-slate-200 dark:border-slate-700">
            <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                ...
                <div class="flex items-center gap-2 text-sm w-full md:w-auto">
                    ...
                    <select id="riwayat-restock-obat-page-length"
                ...
                <div class="w-full md:w-auto">
                    <div class="relative">
                        ...
                        <input type="text" id="riwayat-restock-obat-search-input"
        ...
        <div class="overflow-x-auto">
            <table id="table-riwayat-restock-obat"
        ...
        <div
            ...
            <div id="riwayat-restock-obat-custom-info" class="text-xs md:text-sm text-slate-600 dark:text-slate-300">
            </div>

            <div class="w-full md:w-auto overflow-x-auto">
                <ul id="riwayat-restock-obat-custom-pagination"
...
<div id="riwayat-modal-detail-restock-obat"
    ...
    <div class="w-full max-w-6xl max-h-[95vh] overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div class="flex items-start justify-between border-b border-slate-200 px-6 py-5">
            ...
            <button type="button" id="button-close-modal-detail-riwayat-restock-obat"
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50/70 p-5">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3 text-sm">
                    <div>
                        ...
                        <p id="riwayat-restock-obat-detail_supplier" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Depot</p>
                        <p id="riwayat-restock-obat-detail_depot" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">No Faktur</p>
                        <p id="riwayat-restock-obat-detail_no_faktur" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Tanggal Terima</p>
                        <p id="riwayat-restock-obat-detail_tanggal_terima" class="font-semibold text-slate-800">-</p>
                    </div>
                    <div>
                        <p class="text-slate-500">Tanggal Jatuh Tempo</p>
                        <p id="riwayat-restock-obat-detail_tanggal_jatuh_tempo" class="font-semibold text-slate-800">-
                        </p>
                    </div>
                    <div>
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
                        ...
                        <tbody id="detail-riwayat-restock-obat-tbody" class="divide-y divide-slate-200">
                            <tr>
        ...
        <div class="border-t border-slate-200 px-6 py-4 flex justify-end">
            <button type="button" id="button-close-footer-modal-detail-riwayat-restock-obat"
...
@vite(['resources/js/farmasi/restock-obat/data-riwayat-restock-obat.js'])

    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center gap-2 text-sm">
                ...
                <select id="riwayat-order-layanan-page-length"
            ...
            <div class="w-full md:w-auto">
                <div class="relative">
                    ...
                    <input type="text" id="riwayat-order-layanan-search-input"
        ...
        <div class="overflow-x-auto">
            <table id="tabel-riwayat-order-layanan"
        ...
        <div
            ...
            <div id="riwayat-order-layanan-custom-info" class="text-xs md:text-sm text-slate-600 dark:text-slate-300">
            </div>
            <ul id="riwayat-order-layanan-custom-pagination"

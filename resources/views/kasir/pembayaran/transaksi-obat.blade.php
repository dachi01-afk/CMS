        ...
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    Menampilkan order obat pasien yang belum dibayar dan siap diproses oleh kasir.
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="relative">
                    ...
                    <input type="text" id="transaksi-obat-search-input"
                        class="block w-full md:w-80 pl-9 pr-3 py-2 text-sm
                               ...
                               focus:ring-sky-500 focus:border-sky-500"
                        placeholder="Cari pasien, kode transaksi, status, atau obat...">
                </div>
            </div>
        </div>
            ...
            <table id="transaksiObatTable"
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-4 md:px-6 py-3">Daftar Obat</th>
                        <th class="px-4 md:px-6 py-3">Jumlah Item</th>

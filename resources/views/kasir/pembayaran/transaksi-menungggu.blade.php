...
<div class="overflow-hidden rounded-lg shadow-md">
    ...
    <div class="overflow-x-auto">
        <table id="transaksiMenunggu" class="w-full text-sm text-left text-gray-600">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between px-4 py-3 border-t border-gray-200 gap-3">
        <div id="transaksi-menunggu-custom-info" class="text-sm text-gray-700 dark:text-gray-300"></div>
        <ul id="transaksi-menunggu-custom-pagination" class="inline-flex -space-x-px text-sm"></ul>
    </div>
</div>

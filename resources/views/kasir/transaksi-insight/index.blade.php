...
<head>
    ...
    <title>CMS-Royal-Klinik | Insight Pembayaran</title>
...
<body class="text-slate-900">
    <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="space-y-6">
            ...
            {{-- HERO --}}
            <section
                class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-blue-900 to-blue-700 px-6 py-7 shadow-xl">
                ...
                <div class="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                    <div class="max-w-2xl">
                        ...
                        <h1 class="mt-4 text-3xl font-black tracking-tight text-white md:text-4xl">
                            Insight Pembayaran Alur Default
                        </h1>

                        <p class="mt-2 text-sm leading-6 text-blue-100 md:text-base">
                            Monitoring transaksi pembayaran pasien dari alur default kunjungan klinik.
                        </p>
                    </div>
            ...
            {{-- CHART --}}
            <section id="chartSection" data-chart-url="{{ route('kasir.insight.pembayaran.chart') }}"
                class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="mb-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        <h2 class="text-lg font-bold text-slate-900">Grafik Pembayaran</h2>
                        <p class="mt-1 text-sm text-slate-500">
                            Jumlah transaksi dan pendapatan pembayaran berdasarkan periode.
                        </p>
                    </div>
            ...
            <section class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <div class="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500">
                            Cari transaksi berdasarkan kode, status, atau metode pembayaran.
                        </p>
                    </div>
                    ...
                    <form method="GET" class="flex w-full max-w-md items-center gap-2">
                        <div class="relative flex-1">
                            <input type="text" name="search" value="{{ $search }}"
                                ...
                                class="w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 pr-10 text-sm text-slate-700 shadow-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100">
                            <i

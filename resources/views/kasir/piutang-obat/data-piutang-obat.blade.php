<section class="space-y-5">
        ...
        <div class="flex items-start gap-3 md:flex-1">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Kelola Piutang obat dari supplier secara rapi dan mudah dipantau.
                </p>
            </div>
        </div>
    </div>
    ...
    <div
            ...
            <div class="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
                ...
                <div class="w-full md:w-auto">
                    <div class="relative">
                        ...
                        <input type="text" id="piutang-search-input"
            ...
            <table id="table-piutang"
                ...
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-3 sm:px-4 md:px-6 py-3">Kode Return</th>
                        <th class="px-3 sm:px-4 md:px-6 py-3">Tanggal Piutang</th>
        ...
        <div
            ...
            <div id="piutang-custom-info" class="text-xs md:text-sm text-slate-600 dark:text-slate-300"></div>
            <div class="w-full md:w-auto overflow-x-auto">
                <ul id="piutang-custom-pagination"
...
<div id="modal-detail-piutang" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 px-4">
    <div class="w-full max-w-7xl rounded-2xl bg-white shadow-2xl overflow-hidden">
        <div class="flex items-center justify-between border-b px-6 py-4 bg-slate-50">
            ...
            <button type="button" id="button-close-modal-detail-piutang"
        ...
        <div class="max-h-[85vh] overflow-y-auto p-6 space-y-6">
                ...
                <div class="rounded-2xl border border-slate-200 p-5">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <p id="detail-no-referensi" class="font-semibold text-slate-800">-</p>
                        </div>
                        <div>
                            <p class="text-slate-500">Status Piutang</p>
                            <p id="detail-status-piutang" class="font-semibold text-slate-800">-</p>
                        </div>
                        <div>
                            <p class="text-slate-500">Tanggal Piutang</p>
                            <p id="detail-tanggal-piutang" class="font-semibold text-slate-800">-</p>
                        </div>
                        <div>
                        ...
                        <div class="col-span-2">
                            ...
                            <p id="detail-total-piutang" class="text-lg font-bold text-rose-600">-</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="rounded-2xl border border-slate-200 p-5">
                    <h4 class="text-base font-bold text-slate-800 mb-4">Informasi Return</h4>
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            <p class="text-slate-500">No Referensi Return</p>
                            <p id="detail-return-no-referensi" class="font-semibold text-slate-800">-</p>
                        </div>
                        <div>
                            <p class="text-slate-500">Tanggal Jatuh Tempo</p>
                        ...
                        <div>
                            ...
                            <p id="detail-status-return" class="font-semibold text-slate-800">-</p>
                        </div>
                        <div>
                            <p class="text-slate-500">Depot</p>
                            <p id="detail-return-depot" class="font-semibold text-slate-800">-</p>
                        </div>
                        <div>
                            <p class="text-slate-500">Total Tagihan</p>
                            <p id="detail-return-total-tagihan" class="font-semibold text-slate-800">-</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="rounded-2xl border border-slate-200 overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm text-left text-slate-700">
                        ...
                        <tbody id="detail-piutang-items-body">
                            <tr>
...
@vite(['resources/js/kasir/piutang-obat/data-piutang-obat.js'])

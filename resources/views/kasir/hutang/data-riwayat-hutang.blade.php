        ...
        <div class="flex items-start gap-3 md:flex-1">
            ...
            <div class="min-w-0">
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                    Lihat dan telusuri seluruh data riwayat hutang, mulai dari supplier, depot,
...
<div id="modal-detail-riwayat-hutang"
    ...
    <div
        ...
        <div
            ...
            <div>
                <h3 class="text-xl font-bold text-slate-800 dark:text-slate-100">Detail Hutang</h3>
                <p class="text-sm text-slate-500 dark:text-slate-400">Informasi lengkap data hutang.</p>
            </div>

            <button type="button" id="close-modal-detail-riwayat-hutang"
        ...
        <div class="p-4 md:p-6 max-h-[80vh] overflow-y-auto">
            <div id="detail-riwayat-hutang-loading" class="hidden">
                <div class="flex items-center gap-3 text-slate-600 dark:text-slate-300">
                    <i class="fa-solid fa-spinner fa-spin"></i>
                    <span>Memuat detail data hutang...</span>
                </div>
            </div>

            <div id="detail-riwayat-hutang-error"
                class="hidden rounded-xl border border-red-200 bg-red-50 text-red-600 px-4 py-3 text-sm">
            </div>

            <div id="detail-riwayat-hutang-content" class="hidden space-y-5">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        ...
                        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <p id="detail-riwayat-hutang-no-faktur"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Status Hutang</p>
                                <div id="detail-riwayat-hutang-status-hutang" class="font-semibold">-</div>
                            </div>
                            <div>
                                <p class="text-slate-500">Tanggal Hutang</p>
                                <p id="detail-riwayat-hutang-tanggal-hutang"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Tanggal Jatuh Tempo</p>
                                <p id="detail-riwayat-hutang-tanggal-jatuh-tempo"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Tanggal Pelunasan</p>
                                <p id="detail-riwayat-hutang-tanggal-pelunasan"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Metode Pembayaran</p>
                                <p id="detail-riwayat-hutang-metode-pembayaran"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div class="md:col-span-2">
                                <p class="text-slate-500">Total Hutang</p>
                                <p id="detail-riwayat-hutang-total-hutang" class="font-bold text-lg text-rose-600">Rp 0
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        ...
                        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <p id="detail-riwayat-hutang-nama-supplier"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Kontak Person</p>
                                <p id="detail-riwayat-hutang-kontak-person"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">No HP</p>
                                <p id="detail-riwayat-hutang-no-hp-supplier"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Email</p>
                                <p id="detail-riwayat-hutang-email-supplier"
                                    class="font-semibold text-slate-800 dark:text-slate-100 break-all">-</p>
                            </div>
                            <div class="md:col-span-2">
                                <p class="text-slate-500">Alamat</p>
                                <p id="detail-riwayat-hutang-alamat-supplier"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-700">
                            <h4 class="font-bold text-slate-800 dark:text-slate-100">Informasi Restock</h4>
                        </div>
                        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <p class="text-slate-500">No Faktur Restock</p>
                                <p id="detail-riwayat-hutang-no-faktur-restock"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Tanggal Terima</p>
                                <p id="detail-riwayat-hutang-tanggal-terima"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Tanggal Jatuh Tempo Restock</p>
                                <p id="detail-riwayat-hutang-tanggal-jatuh-tempo-restock"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Status Restock</p>
                                <div id="detail-riwayat-hutang-status-restock" class="font-semibold">-</div>
                            </div>
                            <div>
                                <p class="text-slate-500">Depot</p>
                                <p id="detail-riwayat-hutang-depot"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Total Tagihan</p>
                                <p id="detail-riwayat-hutang-total-tagihan-restock"
                    ...
                    <div class="rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                        ...
                        <div class="p-4 grid grid-cols-1 gap-4 text-sm">
                            <div>
                                ...
                                <p id="detail-riwayat-hutang-dibuat-oleh"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Diupdate Oleh</p>
                                <p id="detail-riwayat-hutang-diupdate-oleh"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Created At</p>
                                <p id="detail-riwayat-hutang-created-at"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                            <div>
                                <p class="text-slate-500">Updated At</p>
                                <p id="detail-riwayat-hutang-updated-at"
                                    class="font-semibold text-slate-800 dark:text-slate-100">-</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <div class="px-4 py-3 border-b border-slate-200 dark:border-slate-700">
                        <h4 class="font-bold text-slate-800 dark:text-slate-100">Detail Item Restock</h4>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-sm">
                            ...
                            <tbody id="detail-riwayat-hutang-detail-item-body"
                ...
                <div class="rounded-2xl border border-slate-200 dark:border-slate-700 p-4">
                    ...
                    <div id="detail-riwayat-hutang-bukti-pembayaran-wrapper">
...
@vite(['resources/js/kasir/hutang/data-riwayat-hutang.js'])

<x-mycomponents.layout>
    ...
    <div>
        ...
        <div class="border-b border-gray-200 dark:border-gray-700 ">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center whitespace-nowrap" id="default-tab"
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="hutang-bhp-tab"
                        data-tabs-target="#data-hutang-bhp" type="button" role="tab"
                        aria-controls="data-hutang-bhp" aria-selected="false">
                        Data Hutang Bahan Habis Pakai
                    </button>
                </li>
        ...
        <div class="p-2 bg-white shadow-lg rounded-lg min-h-screen">
            ...
            {{-- Tabs Content --}}
            <div id="tab-content">
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mt-2" id="data-hutang-bhp" role="tabpanel"
                    aria-labelledby="hutang-bhp-tab">
                    @include('kasir.hutang-bahan-habis-pakai.data-hutang-bahan-habis-pakai')
                </div>
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mt-2" id="data-riwayat-hutang"
                    ...
                    @include('kasir.hutang-bahan-habis-pakai.data-riwayat-hutang-bahan-habis-pakai')
                </div>
            </div>
        </div>
    </div>

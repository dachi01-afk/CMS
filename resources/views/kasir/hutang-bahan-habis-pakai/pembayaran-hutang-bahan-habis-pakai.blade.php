...
<body class="bg-gray-50 dark:bg-gray-900">
    <section class="py-6 md:py-10">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            @php
                $restockBahanHabisPakai = $dataHutang->restockBahanHabisPakai ?? null;
                $supplier = $dataHutang->supplier ?? null;
                $metodePembayaran = $dataHutang->metodePembayaran ?? null;
                $itemsRestock = $restockBahanHabisPakai?->restockBahanHabisPakaiDetail ?? collect();
                $totalHutang = $dataHutang->total_hutang ?? 0;
            @endphp
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="{{ route('kasir.hutang.bahan.habis.pakai') }}"
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-1 gap-4 p-5 sm:grid-cols-2 lg:grid-cols-3">
                            <div>
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ $restockBahanHabisPakai->no_faktur ?? '-' }}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ $restockBahanHabisPakai?->tanggal_terima ? \Carbon\Carbon::parse($restockBahanHabisPakai->tanggal_terima)->translatedFormat('d F Y H:i') : '-' }}
                                </p>
                            </div>
                            ...
                            <div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">Tanggal Jatuh Tempo</p>
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ $restockBahanHabisPakai?->tanggal_jatuh_tempo ? \Carbon\Carbon::parse($restockBahanHabisPakai->tanggal_jatuh_tempo)->translatedFormat('d F Y') : '-' }}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ $restockBahanHabisPakai->status_restock ?? '-' }}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                    Rp {{ number_format($restockBahanHabisPakai->total_tagihan ?? 0, 0, ',', '.') }}
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                    {{ $restockBahanHabisPakai?->supplier?->nama_supplier ?? '-' }}
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="w-full text-left">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th class="w-40 px-5 py-3 text-right">Harga Beli</th>
                                        ...
                                        <tr class="hover:bg-gray-50/70 dark:hover:bg-gray-900/20">
                                            <td class="px-5 py-4">
                                                <div class="font-medium text-gray-900 dark:text-white">
                                                    {{ $item->bahanHabisPakai?->nama_barang ?? '-' }}
                                                </div>
                            ...
                            <div class="mt-4 space-y-3">
                                <dl class="flex items-center justify-between gap-4">
                                    ...
                                    <dd class="text-sm font-semibold text-gray-900 dark:text-white">
                                        Rp
                                        {{ number_format($restockBahanHabisPakai->total_tagihan ?? 0, 0, ',', '.') }}
                                    </dd>
                                </dl>
        ...
        <div class="relative w-full max-w-md">
            <div class="relative overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-gray-800">
                ...
                <form id="formPembayaranCashHutang"
                    action="{{ route('kasir.pembayaran.cash.hutang.bahan.habis.pakai', $dataHutang->no_faktur) }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="space-y-4 p-5">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_pelunasan" value="{{ now()->format('Y-m-d') }}"
                                disabled
        ...
        <div class="relative w-full max-w-2xl">
            <div class="relative overflow-hidden rounded-2xl bg-white shadow-xl dark:bg-gray-800">
                ...
                <form id="formPembayaranTransferHutang"
                    action="{{ route('kasir.pembayaran.transfer.hutang.bahan.habis.pakai', $dataHutang->no_faktur) }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            const redirectUrl = "{{ route('kasir.hutang.bahan.habis.pakai') }}";
